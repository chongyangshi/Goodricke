...
$termDates = array (
	"academicYear" => array("starts" => "2015", "ends" => "2016"), //set "starts" to the year of autumn term, "ends" to the year of spring and summer term
	"autumn" => array("starts" => "28/09", "ends" => "04/12"), //set "starts" to the date of start of autumn term, in the form of "DD/MM"
	"spring" => array("starts" => "04/01", "ends" => "11/03"), //set "starts" to the date of start of spring term, in the form of "DD/MM"
	"summer" => array("starts" => "11/04", "ends" => "17/06"), //set "starts" to the date of start of summer term, in the form of "DD/MM"
);
