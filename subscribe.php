                    ...
                    <div class="col-lg-12">
                        <?php 
                            ...
                            if ((!isset($_GET['e'])) || (!isset($_GET['v']))) {
                                ...
                                echo '<h1>Error</h1><br />';
                                echo '<p>This activation link may have expired or is invalid.</p>';
                                die();
                            }
                                    ...
                                    if ($user_hash == $verification_code) {
                                        ...
                                        if ($client_submission_check_execution = $client_submission_check->execute()) {
                                            ...
                                            if (!isset($client_submission_check_result["active"])) {
                                                ...
                                                if ($client_submission_check_result['active'] == 1) {
                                        ...
                                        if ($client_submission_valid == true) {
                                            ...
                                            $client_submission_set_active = $client_submission->prepare('UPDATE subscriptions SET active=1 WHERE (yorkemail = :email);');
                                            $client_submission_set_active->bindvalue(':email', $client_email);

                                            if ($client_submission_set_active->execute()) {
                                                echo '<h1>Success</h1>';
                                                echo '<p>Your reminder subscription is now set up.</p>';
                                                echo '<p>Thank you.</p>';
                                            }
